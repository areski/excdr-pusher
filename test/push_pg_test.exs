defmodule PusherPGTest do
  ...
  test "test push_cdr insert" do
    cdr_list = [[rowid: 653_039, caller_id_name: "Outbound Call", caller_id_number: "17143604044", destination_number: "17143604044", context: "default", start_stamp: {{2016, 9, 27}, {17, 39, 35, 0}}, answer_stamp: {{2016, 9, 27}, {17, 39, 50, 0}}, end_stamp: {{2016, 9, 27}, {17, 39, 55, 0}}, duration: 20, billsec: 5, uuid: "0ad67b59-56d4-4df4-b491-cd30e836838e", bleg_uuid: "", account_code: "", user_id: "", callrequest_id: 119_102_339, nibble_total_billed: "0.001000", nibble_increment: 6, dialout_phone_number: "17143604044", amd_status: "machine", legtype: "1", hangup_cause_q850: 16, imported: 0, pg_cdr_id: 0, campaign_id: 139, start_uepoch: 1_474_997_975_000_000, answer_uepoch: nil, amd_result: "PERSON"]]
  ...
  test "test build_select_retry" do
    cdr_list = [rowid: 2_210_298, caller_id_name: "", caller_id_number: "16502636531", destination_number: "12094282743", context: "default", start_stamp: {{2017, 7, 19}, {10, 3, 48, 0}}, answer_stamp: nil, end_stamp: {{2017, 7, 19}, {10, 3, 56, 0}}, duration: 8, billsec: 0, uuid: "d68fa513-c087-41c1-b2a0-afed8b62d726", bleg_uuid: "", account_code: "", start_uepoch: 1_500_483_828_069_576, answer_uepoch: 0, user_id: 4, callrequest_id: 25_808_191, nibble_total_billed: "", nibble_increment: 6, dialout_phone_number: "+12094282743", amd_result: "", legtype: "1", hangup_cause_q850: 18, campaign_id: 164, imported: 0, pg_cdr_id: 0]
  ...
  test "test build_select_retry with array" do
    cdr_list = [[rowid: 2_210_298, caller_id_name: "", caller_id_number: "16502636531", destination_number: "12094282743", context: "default", start_stamp: {{2017, 7, 19}, {10, 3, 48, 0}}, answer_stamp: nil, end_stamp: {{2017, 7, 19}, {10, 3, 56, 0}}, duration: 8, billsec: 0, uuid: "d68fa513-c087-41c1-b2a0-afed8b62d726", bleg_uuid: "", account_code: "", start_uepoch: 1_500_483_828_069_576, answer_uepoch: 0, user_id: 4, callrequest_id: 25_808_191, nibble_total_billed: "", nibble_increment: 6, dialout_phone_number: "+12094282743", amd_result: "", legtype: "1", hangup_cause_q850: 18, campaign_id: 164, imported: 0, pg_cdr_id: 0], [rowid: 2_210_298, caller_id_name: "", caller_id_number: "16502636531", destination_number: "12094282743", context: "default", start_stamp: {{2017, 7, 19}, {10, 3, 48, 0}}, answer_stamp: nil, end_stamp: {{2017, 7, 19}, {10, 3, 56, 0}}, duration: 8, billsec: 0, uuid: "d68fa513-c087-41c1-b2a0-afed8b62d726", bleg_uuid: "", account_code: "", start_uepoch: 1_500_483_828_069_576, answer_uepoch: 0, user_id: 4, callrequest_id: 25_808_191, nibble_total_billed: "", nibble_increment: 6, dialout_phone_number: "+12094282743", amd_result: "", legtype: "1", hangup_cause_q850: 18, campaign_id: 164, imported: 0, pg_cdr_id: 0]]
